...
const PayArrearViewer = () => {
  const [isBranchModalOpen, setIsBranchModalOpen] = useState(false);
  const [isVendingServerModalOpen, setIsVendingServerModalOpen] = useState(false);
  const tableHeaders = ["Trans Date", "BranchName", "Vending Server", "TransID", "MeterNum", "Account", "Commision", "Operator"];
...
export default PayArrearViewer;