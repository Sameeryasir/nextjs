    ...
    <div onClick={(e) => e.stopPropagation()} className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-lg shadow-2xl flex flex-col transition-all duration-300 ease-in-out ${modalContainerClasses}`}>
      ...
      <div className="p-6 space-y-4 flex-grow overflow-y-auto">
        <div className="flex items-center gap-4 text-sm pb-4 border-b">
          <label htmlFor="modal_code" className="font-medium text-gray-600">Code</label>
          <input id="modal_code" type="text" className="w-56 px-3 py-2 border border-gray-300 rounded-md" />
          <label htmlFor="modal_name" className="font-medium text-gray-600">Name</label>
          <input id="modal_name" type="text" className="w-56 px-3 py-2 border border-gray-300 rounded-md" />
          ...
          <table className="min-w-full text-sm">
            <thead className="bg-[#FF9900] text-white">
              <tr>
                ...
                {modalTableHeaders.map(header => <th key={header} className="p-3 text-left font-semibold">{header}</th>)}
              </tr>
            </thead>
            <tbody>
  ...
  return (
    <>
      <div className="p-6 w-full bg-white min-h-screen">
        ...
        <form className="space-y-4 max-w-5xl">
          <div className="flex items-center gap-x-4">
            <label className="w-48 text-sm font-medium text-gray-600 text-right">Branch</label>
          ...
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">IMEI</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Type</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Tel No.</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Address</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Owner</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Network Fee</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Pay Date Of Network Fee</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">User Code</label><div className="flex-grow flex items-center gap-1"><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /><button onClick={() => setIsModalOpen(true)} type="button" className="p-2 bg-[#FF9900] text-white rounded-md hover:brightness-95 transition"><MoreHorizontal size={22} /></button></div></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">User Name</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">User Key</label><div className="flex-grow flex items-center gap-1"><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /><button onClick={() => setIsModalOpen(true)} type="button" className="p-2 bg-[#FF9900] text-white rounded-md hover:brightness-95 transition"><MoreHorizontal size={22} /></button></div></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Deduction Amount</label><div className="flex items-center gap-2"><select className="flex-grow px-3 py-2 border border-gray-300 rounded-md bg-white"><option>Branch Account</option></select><input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-[#FF9900] focus:ring-[#FF9900]" /></div></div>
          <div className="flex items-center gap-x-4"><div className="w-48"/> <div className="flex-grow flex items-center gap-2"><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /><span className="text-sm font-semibold">KMF</span></div></div>
          <div className="flex items-start gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right pt-2">Remarks</label><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Amount Balance</label><div className="flex-grow flex items-center gap-2"><input type="text" className="flex-grow px-3 py-2 border border-gray-300 rounded-md" /><span className="text-sm font-semibold">KMF</span></div></div>
          <div className="flex items-center gap-x-4"><label className="w-48 text-sm font-medium text-gray-600 text-right">Active</label><input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-[#FF9900] focus:ring-[#FF9900]" /></div>
...
export default NewPOSTerminalForm;