...
function Page() {
  ...
  const handleExportToExcel = () => {
    ...
    const headers = ["Tiers Parti", "AGENCE", "Date", "Nombre de Trans.", "Montan Total", "Montan KWH", "Energie kWh"];
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "USSD_Report");
  ...
  const tableHeaders = ["Tiers Parti", "AGENCE", "Date", "Nombre de Trans.", "Montan Total", "Montan KWH", "Energie kWh"];
            ...
            {isSearching ? (
              ...
              tableData.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="p-3">{row.TiersParti || 'N/A'}</td>
                  <td className="p-3">{row.AGENCE || 'N/A'}</td>
                  <td className="p-3">{row.Date || 'N/A'}</td>
                  <td className="p-3">{row.NombreDeTrans || 'N/A'}</td>
                  <td className="p-3">{row.MontanTotal || 'N/A'}</td>
                  <td className="p-3">{row.MontanKWH || 'N/A'}</td>
                  <td className="p-3">{row.EnergieKWH || 'N/A'}</td>
                </tr>
              ))
            ) : (
