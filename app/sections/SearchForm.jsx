      ...
      {!showRegisterForm ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
              ...
              <button
                ...
                onClick={() => setShowRegisterForm(true)} // Show form
              >
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">Register New Customer</h2>
            <button
              className="text-sm text-blue-600 underline"
              onClick={() => setShowRegisterForm(false)} // Go back to search
            >
              ← Back to Search
            </button>
          </div>
