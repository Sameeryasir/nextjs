// components/SearchCustomerModal.jsx
import React from "react";

export default function SearchCustomerModal({ isOpen, onClose }) {
  ...
  >
    ✕
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mb-6">
          <div>
            <label className="block text-gray-500 text-sm mb-1">Meter Num</label>
            <input
              type="text"
              className="border border-gray-300 rounded p-2 w-full"
              placeholder="Meter Num"
            />
          </div>
          <div>
          ...
          <div>
            <label className="block text-gray-500 text-sm mb-1">Account No</label>
            <input
              type="text"
              className="border border-gray-300 rounded p-2 w-full"
          ...
          <table className="min-w-full text-sm text-left">
            <thead className="bg-[#FF9900] text-white">
              <tr>
                ...
                <th className="px-2 py-2">Meter Num</th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-white  border-t text-left">
                <td className="px-2 py-2">123456</td>
                <td className="px-2 py-2">2025-01-01</td>
                <td className="px-2 py-2">John Doe</td>
                <td className="px-2 py-2">7891000</td>
                <td className="px-2 py-2">Johny</td>
