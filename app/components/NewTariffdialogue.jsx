...
function Newtariffdialogue({  onClose }) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-2 sm:mx-4 p-4 sm:p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
           ...
           <button className="px-4 sm:px-6 py-2 w-[100px] text-sm sm:text-base bg-gray-800 text-white rounded-md hover:bg-gray-700">Search</button>
          </div>
...
export default Newtariffdialogue;
