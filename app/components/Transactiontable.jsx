        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px] sm:min-w-0">
            <thead className="bg-[#FF9900] text-white">
              <tr>
                <th className="p-2 sm:p-3 text-left">Transaction TIme</th>
                <th className="p-2 sm:p-3 text-left">Meter Number</th>
                <th className="p-2 sm:p-3 text-left">Old key & New Key</th>
                <th className="p-2 sm:p-3 text-left">Key Change Token</th>
                <th className="p-2 sm:p-3 text-left">Rollover Status</th>
                <th className="p-2 sm:p-3 text-left">Transaction Token</th>
                <th className="p-2 sm:p-3 text-left">Cancellation Token</th>
