...
function Compensatingnewbutton() {
                  ...
                  <div className=" bg-transparent p-4 fixed inset-0 z-50 overflow-auto">
                    <div className="bg-gray-100 rounded-lg shadow-lg max-w-6xl mx-auto mt-30">
                      ...
                      <div className="p-4 space-y-4">
                        ...
                        <div>
                          <button 
                          className="px-4 py-1.5 bg-[#0A1E46] text-white rounded hover:bg-[#152a5a] transition-colors">
                            Search
                          </button>
                        </div>
                      </div>
...
export default Compensatingnewbutton;
