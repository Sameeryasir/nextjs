...
/**
 * A modal dialogue for searching and selecting a branch.
...
function BranchSelectionDialogue({ onClose, onSelect }) {
  ...
  const handleSearchClick = () => { fetchBranches(1); };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl p-4 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center gap-2 mb-2">
            ...
            <input type="text" name="name" placeholder="Name" value={search.name} onChange={handleInputChange} className="p-2 border rounded-md w-48"/>
