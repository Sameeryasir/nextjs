      ...
      <div className="max-w-2xl text-left ml-14 mb-10 space-y-8">
        ...
        <section className>
          ...
          <div className="space-y-4">
            ...
            {/* Meter Num */}
            <div className="flex items-center gap-4">
              <label className="w-32 text-sm text-gray-500">FullName</label>
              <input
                type="text"
                className="flex-1 px-3 py-2 border border-gray-200 rounded-md bg-gray-50"
              />
            ...
            <div className="flex items-center gap-4">
              <label className="w-32 text-sm text-gray-500">MeterNum.</label>
        ...
        <section>
          ...
          <div className="space-y-4">
            {/* Date */}
            <div className="flex items-center gap-4">
              <label className="w-32 text-sm text-gray-500">Issue Time</label>
              <input
                type="text"
            ...
            {/* Token Type */}
            <div className="flex items-center gap-4">
              <label className="w-32 text-sm text-gray-500">Issue Power</label>
              <input
                type="text"
                className="w-[280px] px-3 py-2 border border-gray-200 rounded-md bg-gray-50"
              />
            ...
            {/* Token Sub Type */}
            <div className="flex items-center gap-4">
              <label className="w-32 text-sm text-gray-500">Issue Reason</label>
              <input
                type="text"
                className="w-[280px] px-3 py-2 border border-gray-200 rounded-md bg-gray-50"
              />
            ...
            {/* Token Buttons */}
            <div className="flex items-start gap-4">
              <label className="w-32 text-sm text-gray-500 mt-2">
                Issue Token
              </label>
            </div>  
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm text-gray-500"></label>
                <div className="flex gap-2 justify-center mt-10">
                  <button
                    onClick={() => setShowSearchDialog(true)}
                    className="px-4 py-2 bg-[#FF9900] text-white rounded-md hover:cursor-pointer transition-colors"
                  >
                    Search...
                  </button>
                  {showSearchDialog && (
                      ...
                      <div className="bg-gray-100 rounded-lg shadow-lg max-w-6xl mx-auto mt-30">
                        ...
                        <div className="px-4 py-2 flex items-center gap-2">
                          ...
                          <span className="text-sm">
                            Total 1 Records, Record 1 - 1, Page 1/1, Turn To
                            Page
                          </span>
                          <input
                            type="text"
                  ...
                  <button className="px-4 py-2 bg-[#FF9900] text-white rounded-md hover:cursor-pointer transition-colors">
                    Return
                  </button>
                </div>
              </div>
...
export default Freeissuenewbutton;
